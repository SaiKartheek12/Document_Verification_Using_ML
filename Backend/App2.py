...
def loadAllModels():
    ...
    global model_symbol
    global reader
    model = torch.hub.load('ultralytics/yolov5:v7.0', 'custom', path=r"C:\Users\SAI KARTHEEK\OneDrive\Desktop\project\Backend\best (2).pt")
    print("YOLOv5 model loaded successfully!")
    # Set the model to inference mode
    model.eval()
    model_logo = load_model(r"C:\Users\SAI KARTHEEK\Downloads\logo_classification_model.h5")
    model_symbol = load_model(r"C:\Users\SAI KARTHEEK\Downloads\title_classification_model.h5")
...
def serve_image(filename):
    return send_from_directory(r'C:\Users\SAI KARTHEEK\OneDrive\Desktop\project\Backend/Images/cropped', filename)
...
def upload():
    ...
    try:
        ...
        pdf_image.save(Path(r'C:\Users\SAI KARTHEEK\OneDrive\Desktop\project\Backend\Images\Cropped\photo.jpg'))
        ...
        for class_name, best_box in best_boxes.items():
            ...
            cropped_image.save(Path(f'C:\\Users\\SAI KARTHEEK\\OneDrive\\Desktop\\project\\Backend\\Images\\Cropped\\cropped_{class_name}.jpg'))
        ...
        number_path=r'C:\Users\SAI KARTHEEK\OneDrive\Desktop\project\Backend\Images\Cropped\cropped_0.0.jpg'
        ...
        single_image_path = r"C:\Users\SAI KARTHEEK\OneDrive\Desktop\project\Backend\Images\Cropped\cropped_2.0.jpg" 
        ...
        single_image_path = r"C:\Users\SAI KARTHEEK\OneDrive\Desktop\project\Backend\Images\Cropped\cropped_3.0.jpg" 
        ...
        number_path=r'C:\Users\SAI KARTHEEK\OneDrive\Desktop\project\Backend\Images\Cropped\cropped_1.0.jpg'
        if(os.path.exists(number_path)):
            with open(number_path,'rb') as number_file:
                content=number_file.read()
            result = reader.readtext(number_path)
        ...
        number_path=r'C:\Users\SAI KARTHEEK\OneDrive\Desktop\project\Backend\Images\Cropped\cropped_4.0.jpg'
        if(os.path.exists(number_path)):
            with open(number_path,'rb') as number_file:
                content=number_file.read()
            result = reader.readtext(number_path)
